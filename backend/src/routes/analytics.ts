...
router.get('/dashboard', authenticate, asyncHandler(async (req: AuthRequest, res: Response): Promise<void> => {
...
router.get('/trends', authenticate, asyncHandler(async (req: AuthRequest, res: Response): Promise<void> => {
  const businessId = req.user?.businessId;
...
router.get('/outcomes', authenticate, asyncHandler(async (req: AuthRequest, res: Response): Promise<void> => {
  const businessId = req.user?.businessId;
...
router.get('/activity', authenticate, asyncHandler(async (req: AuthRequest, res: Response): Promise<void> => {
  const businessId = req.user?.businessId;
...
router.get('/performance', authenticate, asyncHandler(async (req: AuthRequest, res: Response): Promise<void> => {
  const businessId = req.user?.businessId;
